					...
					if (result == stgBeginOfSection) {
						...
						while (in_section) {
							...
							if (is64Bit) {
								...
								anAccess->creator.name = (STR)acc32.creator.name;
								anAccess->creator.time = acc32.creator.time;
								anAccess->host = (STR)acc32.host;
								anAccess->host2 = (STR)acc32.host2;
								anAccess->host3 = (STR)acc32.host3;
								anAccess->server = (STR)acc32.server;
								anAccess->server2 = (STR)acc32.server2;
								anAccess->server3 = (STR)acc32.server3;
								anAccess->user = (STR)acc32.user;
								anAccess->user2 = (STR)acc32.user2;
								anAccess->user3 = (STR)acc32.user3;
								anAccess->nick = (STR)acc32.nick;
