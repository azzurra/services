...
STDSTR	s_vers_name		= PACKAGE_NAME;
STDSTR	s_vers_buildtime	= " " __DATE__ " " __TIME__;
STDSTR	s_vers_serno		= SERNO;
STDSTR	s_vers_codedby		= "\2Shaka\2, \2Gastaman\2, \2Sonic\2, \2morph\2, \2Scorpion\2";
STDSTR	s_vers_version		= "\2" PACKAGE_VERSION "\2 " VERS_IRCD "+" VERS_CP_TS3 VERS_CP_NOQUIT VERS_CP_SSJOIN VERS_CP_BURST VERS_CP_UNCONNECT VERS_CP_ZIP VERS_CP_NICKIP VERS_CP_TSMODE VERS_CP_DKEY "-" VERS_BF_LANG VERS_BF_POOL VERS_BF_DEBUG VERS_BF_TRACE VERS_BIT "-" BRANCH_NAME_SHORT " [ \2" VERS_CODENAME "\2 ]";
...
void handle_version(const char *source, User *callerUser, ServiceCommandData *data) {
	...
	send_notice_to_user(data->agent->nick, callerUser, "%s", s_vers_name);
	...
	send_notice_to_user(data->agent->nick, callerUser, "Git commit hash: %s", s_vers_serno);
