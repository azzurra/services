...
STDSTR	s_vers_version		= "\2" VERS_MAJOR "." VERS_MINOR "." VERS_REVISION "\2 " VERS_IRCD "+" VERS_CP_TS3 VERS_CP_NOQUIT VERS_CP_SSJOIN VERS_CP_BURST VERS_CP_UNCONNECT VERS_CP_ZIP VERS_CP_NICKIP VERS_CP_TSMODE VERS_CP_DKEY "-" VERS_BF_LANG VERS_BF_POOL VERS_BF_DEBUG VERS_BF_TRACE VERS_BIT "-" BRANCH_NAME_SHORT " [ \2" VERS_CODENAME "\2 ]";
