...
AC_DEFUN([AZSVC_FEATURETEST_LARGENET], [
    ...
    AS_CASE(["x${enable_large_net}"], [xno], [], [xyes], [
        LARGE_NET="Yes"
        AC_DEFINE([AZSVC_ENABLE_LARGE_NET], [1], [Define to 1 if --enable-large-net was given to ./configure])
    ], [
