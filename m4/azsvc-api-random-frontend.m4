...
AC_DEFUN([AZSVC_RANDOM_FRONTEND_USE_ARC4RANDOM], [

    RANDOM_FRONTEND_VAL="AZSVC_API_RANDOM_FRONTEND_ARC4RANDOM"
    RANDOM_FRONTEND="Secure arc4random(3)"
])

AC_DEFUN([AZSVC_RANDOM_FRONTEND_USE_SODIUM], [

    RANDOM_FRONTEND_VAL="AZSVC_API_RANDOM_FRONTEND_SODIUM"
    RANDOM_FRONTEND="Sodium"
])

AC_DEFUN([AZSVC_RANDOM_FRONTEND_USE_OPENSSL], [

    RANDOM_FRONTEND_VAL="AZSVC_API_RANDOM_FRONTEND_OPENSSL"
    RANDOM_FRONTEND="${LIBCRYPTO_NAME}"
])

AC_DEFUN([AZSVC_RANDOM_FRONTEND_USE_INTERNAL], [
    ...
    RANDOM_FRONTEND_VAL="AZSVC_API_RANDOM_FRONTEND_INTERNAL"
    RANDOM_FRONTEND="Internal"
])

AC_DEFUN([AZSVC_DECIDE_RANDOM_FRONTEND], [
    ...
    AC_ARG_WITH([rng-api-frontend],
        [AS_HELP_STRING([--with-rng-api-frontend=@<:@frontend@:>@], [RNG API frontend to use (auto, arc4random, sodium, openssl, internal). Default: auto])],
    ...
    AS_CASE(["x${with_rng_api_frontend}"], [xauto], [
        ...
        AC_MSG_ERROR([invalid option for --with-rng-api-frontend (auto, arc4random, sodium, openssl, internal)])
    ])

    AC_DEFINE_UNQUOTED([AZSVC_API_RANDOM_FRONTEND], [${RANDOM_FRONTEND_VAL}], [Atheme RNG API Frontend])
])
