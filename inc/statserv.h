...
struct _ChannelStats_V10 {
	...
	unsigned long int	totaljoins, totalparts, totalkicks, totalbans, totaloppings, totaldeoppings, totalvoicings, totaldevoicings, totaltopics, totaldelcmodes, totaladdcmodes;
...
extern void statserv_init(const time_t now);
